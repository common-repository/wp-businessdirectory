 ...
 *
 */
class JBusinessDirectoryControllerCompanyMessages extends JControllerAdmin
{
	/**
	 * Display the view
	 *
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'CompanyMessages', $prefix = 'JBusinessDirectoryModel', $config = array('ignore_request' => true))
	{
	...
	public function delete()
	{
		...
		if (!is_array($cid) || count($cid) < 1) {
			...
			// Get the model.
			$model = $this->getModel("CompanyMessage");
		...
		$this->setRedirect('index.php?option=com_jbusinessdirectory&view=companymessages');
	}
}