...
class JBusinessDirectoryControllerReviewCriterias extends JControllerAdmin {
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'ReviewCriteria', $prefix = 'JBusinessDirectoryModel', $config = array('ignore_request' => true)) {
	...
	public function delete() {
		...
		$this->setRedirect('index.php?option=com_jbusinessdirectory&view=reviewcriterias');
	}
