...
class JBusinessDirectoryControllerBookmarks extends JControllerAdmin {
	/**
	 * Display the view
	 *
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Bookmark', $prefix = 'JBusinessDirectoryModel', $config = array('ignore_request' => true)) {
	...
	public function delete() {
		...
		$this->setRedirect('index.php?option=com_jbusinessdirectory&view=bookmarks');
	}
}
