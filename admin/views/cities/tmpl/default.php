		...
		<?php } else { ?>
            ...
            <table class="jtable" id="itemList">
                <thead class="jtable-head">
                    <tr class="jtable-head-row">
                        ...
                        <th class="jtable-head-row-data" width="3%">
                            <?php echo JHtml::_('searchtools.sort', '', 'co.ordering', $listDirn, $listOrder, null, 'asc', 'JGRID_HEADING_ORDERING', 'icon-menu-2'); ?>
                        </th>
                        ...
                        <th class="jtable-head-row-data">
                            <?php echo HTMLHelper::_('searchtools.sort', 'LNG_NAME', 'co.name', $listDirn, $listOrder); ?>
                        </th>
                        <th class="jtable-head-row-data">
                            <?php echo HTMLHelper::_('searchtools.sort', 'LNG_REGION', 'rg.name', $listDirn, $listOrder); ?>
                        </th>
                        <th class="jtable-head-row-data"  width="3%"><?php echo HTMLHelper::_('searchtools.sort', 'LNG_ID', 'co.id', $listDirn, $listOrder); ?></th>
                    </tr>
                </thead>
                <tfoot>
                    <tr>
                ...
                <?php $nrcrt = 1; $i=0;
                    ...
                    $ordering  = ($listOrder == 'co.ordering');
                    $canCreate  = true;
                    $canEdit    = true;
                    $canChange  = true;
                    ?>
                    <tr class="jtable-body-row" data-draggable-group="3">
                        ...
                        <td class="jtable-body-row-data">
                            <a
                                    href='<?php echo JRoute::_('index.php?option=com_jbusinessdirectory&task=city.edit&id='.$item->id)?>'
