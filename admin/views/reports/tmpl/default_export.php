...
<div class="jbd-container jbd-edit-container" id="export-model" style="display: none">
    <form action="<?php echo JRoute::_('index.php?option=com_jbusinessdirectory&view=reports');?>" method="post" name="exportForm" id="exportForm">
        <div class="jmodal-sm">
            ...
            <div class="jmodal-body">
                ...
                <input type="hidden" name="task" id="task" value="reports.exportReportToCSV" />
                <input type="hidden" name="reportId" value="<?php echo $this->report->report->id; ?>" />
