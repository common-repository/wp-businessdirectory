 ...
 */
class JBusinessDirectoryModelReviewCriterias extends JModelList {
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery() {
		...
		$query->from($db->quoteName('#__jbusinessdirectory_company_reviews_criteria').' AS ct');
	...
	public function reorder($pk, $direction = 0) {
		...
		$pk	= (!empty($pk)) ? $pk : (int) $this->getState('reviewcriteria.id');
		// Get an instance of the record's table.
		$table = JTable::getInstance('ReviewCriteria');
