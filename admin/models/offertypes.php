 ...
 */
class JBusinessDirectoryModelOfferTypes extends JModelList {
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery() {
		...
		$query->from($db->quoteName('#__jbusinessdirectory_company_offer_types') . ' AS ct');
	...
	public function reorder($pk, $direction = 0) {
		...
		$pk = (!empty($pk)) ? $pk : (int)$this->getState('offertype.id');
		// Get an instance of the record's table.
		$table = JTable::getInstance('EventType');
	...
	public function saveorder($pks, $order) {
		...
		$table = JTable::getInstance('OfferType');
		$conditions = array();
