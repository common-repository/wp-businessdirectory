...
class JFormFieldCurrencies extends JFormFieldList {
	...
	protected function getOptions() {
		$options = array();
		$options[] = JHtml::_('select.option', "", JTEXT::_("LNG_ALL_CURRENCIES"));
		...
		$query = "SELECT currency_id as id, currency_name as name FROM #__jbusinessdirectory_currencies
                  order by currency_name desc";
