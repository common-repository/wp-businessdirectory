    		...
    		<div class="d-flex flex-column">
    			...
    			<?php if((!isset($this->company->userId) || $this->company->userId == 0) && $appSettings->claim_business) { ?>
                    <div class="claim-listing-wrapper">
                       ...
                       <a class="round-border-buton" href="<?php echo JRoute::_('index.php?option=com_jbusinessdirectory&task=businessuser.checkUser&claim_listing_id='.$this->company->id.$menuItemId) ?>"><?php echo JText::_('LNG_CLAIM_COMPANY')?></a>
                    </div>
                <?php  } ?>
    		</div>
    	</div>
