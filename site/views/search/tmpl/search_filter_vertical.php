...
<div id="search-filter" class="search-filter <?php echo $this->appSettings->search_filter_view==2?"style-2":"" ?>">
	<div class="filter-fav clear" style="display:none"> 
		<a href="javascript:jbdListings.filterByFavorites(<?php echo $user->ID==0?'false':'true' ?>)" style="float:right;padding:5px;"><?php echo JText::_('LNG_FILTER_BY_FAVORITES'); ?></a>
	</div>
				...
				<ul>
					<li>
						<?php if($this->radius != 50) { ?>
							<a href="javascript:jbdListings.setRadius(50)">50 <?php echo $this->appSettings->metric==1?JText::_("LNG_MILES"):JText::_("LNG_KM") ?></a>
						<?php } else { ?>
					...
					<li>
						<?php if($this->radius != 25) { ?>
							<a href="javascript:jbdListings.setRadius(25)">25 <?php echo $this->appSettings->metric==1?JText::_("LNG_MILES"):JText::_("LNG_KM") ?></a>
						<?php } else { ?>
					...
					<li>
						<?php if($this->radius != 10) { ?>
							<a href="javascript:jbdListings.setRadius(10)">10 <?php echo $this->appSettings->metric==1?JText::_("LNG_MILES"):JText::_("LNG_KM") ?></a>
						<?php } else { ?>
					...
					<li>
						<?php if($this->radius != 0) { ?>
							<a href="javascript:jbdListings.setRadius(0)"><?php echo JText::_("LNG_ALL")?></a>
						<?php } else { ?>
		            ...
		            <ul>
		                <?php foreach ($this->searchFilter["categories"] as $filterCriteria) {
		                    if ($counterCategories < $this->appSettings->search_filter_items) {
		                            ...
		                            <li>
		                                <?php if (isset($this->category) && $filterCriteria[0][0]->id == $this->category->id) { ?>
		                                    <strong><?php echo $filterCriteria[0][0]->name; ?>
		                                        &nbsp;</strong>
		                                <?php } else { ?>
		                                    <a href="javascript:jbdUtils.chooseCategory(<?php echo $filterCriteria[0][0]->id ?>)"><?php echo $filterCriteria[0][0]->name; ?></a>
		                                <?php } ?>
		                            </li>
		                        <?php }
		                        $counterCategories++;
		                        ...
		                        <a id="showMoreCategories" class="filterExpand" href="javascript:void(0)"
		                           onclick="jbdUtils.showMoreParams('extra_categories_params','showMoreCategories')"><?php echo JText::_("LNG_MORE") . " (+)" ?></a>
		                        <?php break;
		                    }
		                } ?>
		                ...
		                <div style="display: none" id="extra_categories_params">
		                    ...
		                    <a id="showLessCategories" class="filterExpand" href="javascript:void(0)"
		                       onclick="jbdUtils.showLessParams('extra_categories_params','showMoreCategories')"><?php echo JText::_("LNG_LESS") . " (-)" ?></a>
		                </div>
		            </ul>
		        <?php } else { ?>
		            <ul class="filter-categories">
		                ...
		                foreach ($this->searchFilter["categories"] as $filterCriteria) {
		                            ...
		                            <li <?php if (in_array($filterCriteria[0][0]->id, $this->selectedCategories)) echo 'class="selectedlink"'; ?>>
		                                <div <?php if (in_array($filterCriteria[0][0]->id, $this->selectedCategories)) echo 'class="selected"'; ?>>
		                                    <a href="javascript:void(0)" class="filter-main-cat"
		                                       onclick="<?php echo in_array($filterCriteria[0][0]->id, $this->selectedCategories) ? "jbdUtils.removeFilterRuleCategory(" . $filterCriteria[0][0]->id . ")" : "jbdUtils.addFilterRuleCategory(" . $filterCriteria[0][0]->id . ")"; ?>"> <?php echo $filterCriteria[0][0]->name ?><?php echo in_array($filterCriteria[0][0]->id, $this->selectedCategories) ? '<span class="cross">(remove)</span>' : ""; ?></a>
		                                    <?php //echo '('.$filterCriteria[1].')' ?>
		                                </div>
		                                            ...
		                                            <li <?php if (in_array($subcategory[0]->id, $this->selectedCategories)) echo 'class="selectedlink"'; ?>>
		                                                <div <?php if (in_array($subcategory[0]->id, $this->selectedCategories)) echo 'class="selected"'; ?>>
		                                                    <a href="javascript:void(0)"
		                                                       onclick="<?php echo in_array($subcategory[0]->id, $this->selectedCategories) ? "jbdUtils.removeFilterRuleCategory(" . $subcategory[0]->id . ")" : "jbdUtils.addFilterRuleCategory(" . $subcategory[0]->id . ")"; ?>"> <?php echo $subcategory[0]->name ?><?php echo in_array($subcategory[0]->id, $this->selectedCategories) ? '<span class="cross">(remove)</span>' : ""; ?></a>
		                                                </div>
		                                            </li>
		                                        <?php } ?>
		                                    </ul>
		                    ...
		                    <?php } else { ?>
		                        <a id="showMoreCategories1" class="filterExpand" href="javascript:void(0)"
		                           onclick="jbdUtils.showMoreParams('extra_categories_params1','showMoreCategories1')"><?php echo JText::_("LNG_MORE") . " (+)" ?></a>
		                        <?php break;
		                    }
		                } ?>
		                <div style="display: none" id="extra_categories_params1">
		                    ...
		                    <a id="showLessCategories1" class="filterExpand" href="javascript:void(0)"
		                       onclick="jbdUtils.showLessParams('extra_categories_params1','showMoreCategories1')"><?php echo JText::_("LNG_LESS") . " (-)"  ?></a>
		                </div>
		            </ul>
                        ...
                        foreach($this->searchFilter["starRating"] as $filterCriteria) { ?>
                            ...
                            <li <?php if($searchType == 1 && $selected) echo 'class="selectedlink"'; ?>>
                                <div <?php if($selected) echo 'class="selected"'; ?>>
                                    <a href="javascript:void(0)" onclick="<?php echo $selected?"jbdListings.removeFilterRule('starRating', ".$filterCriteria->reviewScore.")":"jbdListings.addFilterRule('starRating', ".$filterCriteria->reviewScore.")";?>"><?php echo $filterCriteria->reviewScore." ".JText::_("LNG_STARS"); ?><?php echo ($selected)?'<span class="cross">(remove)</span>':"";  ?></a>
                                </div>
                            </li>
                        <?php } ?>
                    </ul>
		            ...
		            <ul>
		                ...
		                foreach ($this->searchFilter["types"] as $filterCriteria) { ?>
		                    ...
		                    <?php if ($counterTypes < $this->appSettings->search_filter_items) { ?>
		                        ...
		                        <li <?php if ($searchType == 1 && $selected) echo 'class="selectedlink"'; ?>>
		                            <div <?php if ($selected) echo 'class="selected"'; ?>>
		                                <a href="javascript:void(0)"
		                                   onclick="<?php echo ($selected) ? "jbdListings.removeFilterRule('type', " . $filterCriteria->typeId . ")" : "jbdListings.addFilterRule('type', " . $filterCriteria->typeId . ")"; ?>"><?php echo $filterCriteria->typeName; ?><?php echo ($selected) ? '<span class="cross">(remove)</span>' : ""; ?></a>
		                            </div>
		                        </li>
		                        <?php $counterTypes++;
		                    } else { ?>
		                        <a id="showMoreTypes" class="filterExpand" href="javascript:void(0)"
		                           onclick="jbdUtils.showMoreParams('extra_types_params','showMoreTypes')"><?php echo JText::_("LNG_MORE") . " (+)"  ?></a>
		                        <?php break;
		                    }
		                }
		                ?>
		                <div style="display: none" id="extra_types_params">
		                    ...
		                    <a id="showLessTypes" class="filterExpand" href="javascript:void(0)"
		                       onclick="jbdUtils.showLessParams('extra_types_params','showMoreTypes')"><?php echo JText::_("LNG_LESS") . " (-)"  ?></a>
		                </div>
		            </ul>
		            <div class="clear"></div>
		          </div>
		            ...
		            <ul>
		                ...
		                foreach ($this->searchFilter["countries"] as $filterCriteria) { ?>
		                    ...
		                    <?php if ($counterCountries < $this->appSettings->search_filter_items) { ?>
		                        <li <?php if ($searchType == 1 && $selected) echo 'class="selectedlink"'; ?>>
		                            <div <?php if ($selected) echo 'class="selected"'; ?>>
		                                <a href="javascript:void(0)"
		                                   onclick="<?php echo $selected ? "jbdListings.removeFilterRule('country', " . $filterCriteria->countryId . ")" : "jbdListings.addFilterRule('country', " . $filterCriteria->countryId . ")"; ?>"><?php echo $filterCriteria->countryName; ?><?php echo ($selected) ? '<span class="cross">(remove)</span>' : ""; ?></a>
		                            </div>
		                        </li>
		                        <?php $counterCountries++;
		                    } else { ?>
		                        <a id="showMoreCountries" class="filterExpand" href="javascript:void(0)"
		                           onclick="jbdUtils.showMoreParams('extra_countries_params','showMoreCountries')"><?php echo JText::_("LNG_MORE") . " (+)"  ?></a>
		                        <?php break;
		                    } ?>
		                <?php } ?>
		                <div style="display: none" id="extra_countries_params">
		                    ...
		                    <a id="showLessCountries" class="filterExpand" href="javascript:void(0)"
		                       onclick="jbdUtils.showLessParams('extra_countries_params','showMoreCountries')"><?php echo JText::_("LNG_LESS") . " (-)"  ?></a>
		                </div>
		            </ul>
		            <div class="clear"></div>
	            </div>
		            ...
		            <ul>
		                ...
		                foreach ($this->searchFilter["regions"] as $filterCriteria) { ?>
		                    ...
		                    <?php if ($counterRegions < $this->appSettings->search_filter_items) { ?>
		                        ...
		                        <li <?php if ($searchType == 1 && $selected) echo 'class="selectedlink"'; ?>>
		                            <div <?php if ($selected) echo 'class="selected"'; ?>>
		                                <a href="javascript:void(0)"
		                                   onclick="<?php echo $selected ? "jbdListings.removeFilterRule('region', &quot;" . $this->escape($filterCriteria->region) . "&quot;)" : "jbdListings.addFilterRule('region', &quot;".$this->escape($filterCriteria->region)."&quot;)"; ?>"><?php echo $this->escape($filterCriteria->regionName); ?><?php echo ($selected) ? '<span class="cross">(remove)</span>' : ""; ?></a>
		                            </div>
		                        </li>
		                        <?php $counterRegions++;
		                    } else { ?>
		                        <a id="showMoreRegions" class="filterExpand" href="javascript:void(0)"
		                           onclick="jbdUtils.showMoreParams('extra_regions_params','showMoreRegions')"><?php echo JText::_("LNG_MORE") . " (+)"  ?></a>
		                        <?php break;
		                    } ?>
		                <?php } ?>
		                <div style="display: none" id="extra_regions_params">
		                    ...
		                    <a id="showLessRegions" class="filterExpand" href="javascript:void(0)"
		                       onclick="jbdUtils.showLessParams('extra_regions_params','showMoreRegions')"><?php echo JText::_("LNG_LESS") . " (-)"  ?></a>
		                </div>
		            </ul>
		            <div class="clear"></div>
		        </div>
		            ...
		            <ul>
		                    ...
		                    <?php if ($counterCities < $this->appSettings->search_filter_items) { ?>
		                        <li <?php if ($searchType == 1 && $selected) echo 'class="selectedlink"'; ?>>
		                            <div <?php if ($selected) echo 'class="selected"'; ?> class="selectedlink">
		                                <a href="javascript:void(0)"
		                                   onclick="<?php echo $selected ? "jbdListings.removeFilterRule('city', &quot;" . $this->escape($filterCriteria->city) . "&quot;)" : "jbdListings.addFilterRule('city', &quot;".$this->escape($filterCriteria->city)."&quot;)"; ?>"><?php echo $this->escape($filterCriteria->cityName); ?><?php echo ($selected) ? '<span class="cross">(remove)</span>' : ""; ?></a>
		                            </div>
		                        </li>
		                        <?php $counterCities++;
		                    } else { ?>
		                        <a id="showMoreCities" class="filterExpand" href="javascript:void(0)"
		                           onclick="jbdUtils.showMoreParams('extra_cities_params','showMoreCities')"><?php echo JText::_("LNG_MORE") . " (+)"  ?></a>
		                        <?php break;
		                    } ?>
		                <?php } ?>
		                <div style="display: none" id="extra_cities_params">
		                    ...
		                    <a id="showLessCities" class="filterExpand" href="javascript:void(0)"
		                       onclick="jbdUtils.showLessParams('extra_cities_params','showMoreCities','showLessCities')"><?php echo JText::_("LNG_LESS") . " (-)"  ?></a>
		                </div>
		            </ul>
		            <div class="clear"></div>
		         </div>
					...
					<ul>
						...
						foreach ($this->searchFilter["areas"] as $filterCriteria) { ?>
							...
							<?php if ($counterAreas < $this->appSettings->search_filter_items) { ?>
								<li <?php if ($searchType == 1 && $selected) echo 'class="selectedlink"'; ?>>
									<div <?php if ($selected) echo 'class="selected"'; ?>>
										<a href="javascript:void(0)"
										   onclick="<?php echo $selected ? "jbdListings.removeFilterRule('area', &quot;" . $this->escape($filterCriteria->areaName) . "&quot;)" : "jbdListings.addFilterRule('area', &quot;".$this->escape($filterCriteria->areaName)."&quot;)"; ?>"><?php echo $this->escape($filterCriteria->areaName); ?><?php echo ($selected) ? '<span class="cross">(remove)</span>' : ""; ?></a>
									</div>
								</li>
								<?php $counterAreas++;
							} else { ?>
								<a id="showMoreAreas" class="filterExpand" href="javascript:void(0)"
								   onclick="jbdUtils.showMoreParams('extra_areas_params','showMoreAreas')"><?php echo JText::_("LNG_MORE") . " (+)"  ?></a>
								<?php break;
							} ?>
						<?php } ?>
						<div style="display: none" id="extra_areas_params">
							...
							<a id="showLessAreas" class="filterExpand" href="javascript:void(0)"
							   onclick="jbdUtils.showLessParams('extra_areas_params','showMoreAreas','showLessAreas')"><?php echo JText::_("LNG_LESS") . " (-)"  ?></a>
						</div>
					</ul>
					<div class="clear"></div>
				</div>
                    ...
                    <ul>
                        ...
                        foreach ($this->searchFilter["provinces"] as $filterCriteria) { ?>
                            ...
                            <?php if ($counterProvinces < $this->appSettings->search_filter_items) { ?>
                                <li <?php if ($searchType == 1 && $selected) echo 'class="selectedlink"'; ?>>
                                    <div <?php if ($selected) echo 'class="selected"'; ?>>
                                        <a href="javascript:void(0)"
                                           onclick="<?php echo $selected ? "jbdListings.removeFilterRule('province', &quot;" . $this->escape($filterCriteria->provinceName) . "&quot;)" : "jbdListings.addFilterRule('province', &quot;".$this->escape($filterCriteria->provinceName)."&quot;)"; ?>"><?php echo $this->escape($filterCriteria->provinceName); ?><?php echo ($selected) ? '<span class="cross">(remove)</span>' : ""; ?></a>
                                    </div>
                                </li>
                                <?php $counterProvinces++;
                            } else { ?>
                                <a id="showMoreProvinces" class="filterExpand" href="javascript:void(0)"
                                   onclick="jbdUtils.showMoreParams('extra_provinces_params','showMoreProvinces')"><?php echo JText::_("LNG_MORE") . " (+)"  ?></a>
                                <?php break;
                            } ?>
                        <?php } ?>
                        <div style="display: none" id="extra_provinces_params">
                            ...
                            <a id="showLessProvinces" class="filterExpand" href="javascript:void(0)"
                               onclick="jbdUtils.showLessParams('extra_provinces_params','showMoreProvinces','showLessProvinces')"><?php echo JText::_("LNG_LESS") . " (-)"  ?></a>
                        </div>
                    </ul>
                    <div class="clear"></div>
                </div>
