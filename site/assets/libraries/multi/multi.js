...
(function($) {
    ...
    $.fn.multi = function( options ) {
        ...
        var settings = $.extend({
            'enable_search': true,
            'search_placeholder_not_selected': 'Search...',
            'search_placeholder_selected': 'Search for selected options...',
        ...
        return this.each( function() {
            ...
            if ( settings.enable_search ) {
                //first search
                var $searchWrapper = $('<div class="search-wrapper has-jicon-left pb-1"></div>');
                var $laIcon = $('<i class="la la-search"></i>');
                var $search = $('<input class="search-input form-control" type="text" />').prop('placeholder', settings.search_placeholder_not_selected);
