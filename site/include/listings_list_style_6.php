...
?>
<div id="jbd-results-list-container" itemscope itemtype="http://schema.org/ItemList" class="list-style-6" <?php echo $appSettings->search_view_mode?'style="display: none"':'' ?>>
    <?php
                        ...
                        <div>
                            <div class="item-options">
                                ...
                                <?php if(!empty($company->employees)){?>
                                    <div class="item-option" title="<?php echo JText::_('LNG_EMPLOYEES') ?>"><i class="icon user"></i> <?php echo $company->employees ?> </div>
                                <?php } ?>
                                <?php if(!empty($company->min_project_size)){?>
                                    <div class="item-option" title="<?php echo JText::_('LNG_MIN_PROJECT_SIZE') ?>"><i class="icon tag"></i> <?php echo $company->min_project_size ?> </div>
                                <?php } ?>
                                <?php if(!empty($company->hourly_rate)){?>
                                    <div class="item-option" title="<?php echo JText::_('LNG_HOURLY_RATE') ?>"><i class="icon clock"></i> <?php echo $company->hourly_rate ?> <?php echo $appSettings->currency_symbol ?> / h</div>
                                <?php } ?>
