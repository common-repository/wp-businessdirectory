...
?>
<div id="jbd-results-list-container" itemscope itemtype="http://schema.org/ItemList" class="list-style-1" <?php echo $appSettings->search_view_mode?'style="display: none"':'' ?>>
    <?php
