...
class JBusinessDirectoryControllerManageReviews extends JBusinessDirectoryControllerReviews {
	/**
	...
	public function delete() {
		...
		if (empty($cid)) {
			...
			// Get the model.
			$model = $this->getModel("ManageReviews");
		...
		$this->setRedirect('index.php?option=com_jbusinessdirectory&view=managereviews');
	}
}
