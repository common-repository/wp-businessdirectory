...
abstract class FormField
{
	...
	/**
	 * Set the max items for an element
	 * @var int
	 */
	 ...
	 * @var  string
	 */
	protected $renderLayout = 'form.renderfield';
	 ...
	 * @var  string
	 */
	protected $renderLabelLayout = 'form.renderlabel';
	...
	public function setup(\SimpleXMLElement $element, $value, $group = null)
	{
		...
		$attributes = array(
			...
			'required','htmleditor','maxitems', 'disabled', 'readonly', 'autofocus', 'hidden', 'autocomplete', 'spellcheck', 'translateHint', 'translateLabel',
	...
	protected function getInput()
	{
		...
		$result = $this->getRenderer($this->layout)->render($this->getLayoutData());
	...
	protected function getLayoutData()
	{
		...
		return array(
		    ...
		    'htmleditor'     => (bool) $this->htmleditor,
