 ...
 * 		layout="form.field.subform.repeatable-table" groupByFieldset="false" component="com_example" client="site"
...
class JFormFieldSubform extends JFormField
{
	 ...
	 * @var  string
	 */
	protected $layout = 'form.field.subform.default';
		...
		switch ($name)
		{
			...
			case 'layout':
				...
				if (!$this->layout)
				{
					...
					$this->layout = !$this->multiple ? 'form.field.subform.default' : 'form.field.subform.repeatable';
				}
