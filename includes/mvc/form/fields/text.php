 ...
 * @since  11.1
 */
class JFormFieldText extends FormField
{
	/**
	 * The form field type.
	 *
	 ...
	 * @since  3.7
	 */
	protected $layout = 'form.field.text';
	...
	protected function getInput()
	{
		...
		//var_dump("text renderer");
		//var_dump($this->getRenderer($this->layout));
