...
use MVC\Application\ComponentHelper;
use MVC\Filter\OutputFilter as JOutputFilter;
...
class ApplicationHelper
{
	...
	public static function stringURLSafe($string, $language = '')
	{
		...
		{
			$output = JOutputFilter::stringURLUnicodeSlug($string);
		}
		else
		{
			$output = JOutputFilter::stringURLSafe($string, "en-GB");
		}
