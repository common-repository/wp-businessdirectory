...
use MVC\Input\Input;
use MVC\Session\MetadataManager;
...
class CMSApplication extends WebApplication
{
	...
	public function getMessageQueue($clear = false)
	{
	    ...
	    /*require_once WP_BUSINESSDIRECTORY_PATH."/includes/logger.php";
	     $log = \Logger::getInstance();
	     $log->LogDebug("get MssageQueu");
	     $log->LogDebug(debug_backtrace());
