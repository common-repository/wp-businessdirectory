...
class HtmlView extends \JObject {
	 ...
	 * We support a multiple model single
	 ...
	 *
	 * @param string $layout
	 *        	The layout name or a string in format <template>:<layout file>
	 *        	
	...
	protected function _setPath($type, $path) {
		...
		switch (strtolower ( $type )) {
			case 'template' :
					$fallback = WP_BUSINESSDIRECTORY_PATH."/overrides/". $this->getName();
