...
class Pagination
{
	...
	public function __construct($total, $limitstart, $limit, $prefix = '', CMSApplication $app = null)
	{
		...
		$displayedPages = $this->pagesTotal;
	...
	public function getPagesLinks()
	{
		...
		if (file_exists($chromePath))
		{
			...
			{
				\JLog::add(
					'pagination_item_active and pagination_item_inactive are deprecated. Use the layout pagination.link instead.',
					\JLog::WARNING,
					'deprecated'
				);
			...
			{
				\JLog::add('pagination_list_render is deprecated. Use the layout pagination.list instead.', \JLog::WARNING, 'deprecated');
				$listOverride = true;
			}
		}
	...
	public function getPaginationLinks($layoutId = 'pagination.links', $options = array())
	{
		...
		$layoutId = $layoutId === null ? 'pagination.links' : $layoutId;
	...
	public function getListFooter()
	{
		...
		$chromePath = "";//PATH_THEMES . '/' . $this->app->getTemplate() . '/html/pagination.php';
		...
		if (file_exists($chromePath))
		{
			...
			{
				\JLog::add('pagination_list_footer is deprecated. Use the layout pagination.links instead.', \JLog::WARNING, 'deprecated');
	...
	{
		return \JLayoutHelper::render('pagination.list', array('list' => $list));
	}
	 ...
	 *
	 * @since   1.5
	 * @note    As of 4.0 this method will proxy to `\JLayoutHelper::render('pagination.link', ['data' => $item, 'active' => true])`
	 */
	protected function _item_active(PaginationObject $item)
	{
		...
		return '<a' . $title . ' href="#" onclick="document.adminForm.' . $this->prefix
			. 'limitstart.value=' . ($item->base > 0 ? $item->base : '0') . '; JBD.submitform();return false;">' . $item->text . '</a>';
	}
	 ...
	 *
	 * @since   1.5
	 * @note    As of 4.0 this method will proxy to `\JLayoutHelper::render('pagination.link', ['data' => $item, 'active' => false])`
	 */
