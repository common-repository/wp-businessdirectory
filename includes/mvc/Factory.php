...
use MVC\Access\Access;
use MVC\Application\CMSApplication;
use MVC\Cache\Cache;
use MVC\Date\Date;
use MVC\Editor\Editor;
use MVC\Input\Input;
use MVC\Language\Language;
use MVC\Log\Log;
use MVC\Mail\Mail;
use MVC\Mail\MailHelper;
use MVC\Session\Session;
use MVC\Uri\Uri;
use MVC\User\User;
use MVC\Registry\Registry;
use MVC\Database\WPDatabaseDriver;
...
//			}
		...
		self::$config->set('tmp_path', WP_BUSINESS_DIRECTORY_TMP_PATH);
	 ...
	 *
	 * @return  \MVC\Cache\CacheController object
	 *
	 * @see     JCache
	 * @since   11.1
	 */
...
//		return self::$cache[$hash];
	...
	protected static function createDbo()
	{
		...
		try
		{
			$db = new WPDatabaseDriver($options);
		}
