...
abstract class JHtmlBehavior
{
	...
	public static function core()
	{
		...
		JFactory::getDocument()->addScriptOptions('system.paths', array('root' => WP_BUSINESS_DIRECTORY_BASE_URL, 'base' => WP_BUSINESS_DIRECTORY_ADMIN_URL));
	...
	public static function modal($selector = 'a.modal', $params = array())
	{
		...
		//('JHtmlBehavior::modal is deprecated. Use the modal equivalent from bootstrap.', JLog::WARNING, 'deprecated');
	...
	public static function multiselect($id = 'adminForm')
	{
		...
		//JBusinessUtil::enqueueScript('multiselect.js');
	...
	public static function calendar()
	{
		...
		$document = JFactory::getDocument();
		$tag      = JBusinessUtil::getLanguageTag();
	...
	public static function colorpicker()
	{
        ...
        wp_enqueue_script('jquery.minicolors.min.js', WP_BUSINESSDIRECTORY_URL.'includes/mvc/js/jquery.minicolors.min.js');
        wp_enqueue_style('css/jquery.minicolors.css', WP_BUSINESSDIRECTORY_URL.'includes/mvc/css/jquery.minicolors.css');
		JFactory::getDocument()->addScriptDeclaration("
				jQuery(document).ready(function (){
	...
	public static function highlighter(array $terms, $start = 'highlighter-start', $end = 'highlighter-end', $className = 'highlight', $tag = 'span')
	{
		...
		$document->addScriptDeclaration("
			jQuery(function ($) {
				...
				if (!start || !end || !JBD.Highlighter) {
					return true;
				}
				highlighter = new JBD.Highlighter({
					startElement: start,
					endElement: end,
					className: '" . $className . "',
					onlyWords: false,
