...
class Toolbar
{
	...
	public function loadButtonType($type, $new = false)
	{
		...
		if (!class_exists('\\MVC\\Toolbar\\ToolbarButton'))
		{
		...
		if (!$buttonClass)
		{
			...
			else
			{
				...
				print(\JText::sprintf('JLIB_HTML_BUTTON_NO_LOAD', $buttonClass, $buttonFile));
				return false;
			}
	...
	{
		$buttonClasses = array(
			'MVC\\Toolbar\\Button\\' . ucfirst($type) . 'Button',
			// @deprecated 3.8.0
