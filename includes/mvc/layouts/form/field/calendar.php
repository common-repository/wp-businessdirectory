...
wp_enqueue_script('calendar-locale', WP_BUSINESSDIRECTORY_URL.'includes/mvc/js/'.$localesPath );
wp_enqueue_script('calendar-helper', WP_BUSINESSDIRECTORY_URL.'includes/mvc/js/'.$helperPath );

wp_enqueue_script('businessdirectory-calendar', WP_BUSINESSDIRECTORY_URL.'includes/mvc/js/calendar.min.js' );
wp_enqueue_style('businessdirectory-calendar', WP_BUSINESSDIRECTORY_URL.'includes/mvc/css/calendar.css' );
...
<div class="field-calendar">
	...
	<div class="input-append">
		...
		<button type="button" class="<?php echo ($readonly || $disabled) ? 'hidden ' : ''; ?>button button-secondary"
			id="<?php echo  $id; ?>_btn"
