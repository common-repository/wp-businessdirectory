...
namespace MVC\Session\Storage;

use MVC\Session\Storage;
use MVC\Database\DatabaseDriver;
	...
	public function __construct($options = array())
	{
		...
		else
		{
			throw new \RuntimeException(
				sprintf('The %s storage engine requires a `db` option that is an instance ofMVC\\Database\\DatabaseDriver.', __CLASS__)
			);
		}
	}
