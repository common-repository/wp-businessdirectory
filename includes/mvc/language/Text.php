...
class Text
{
	 ...
	 *
	 * Examples:
	 * `<script>alert(JBD.JText._('<?php echo Text::_("JDEFAULT", array("script"=>true)); ?>'));</script>`
	 ...
	 *
	 * Examples:
	 * `<script>alert(JBD.JText._('<?php echo Text::plural("COM_PLUGINS_N_ITEMS_UNPUBLISHED", 1, array("script"=>true)); ?>'));</script>`
	...
	public static function script($string = null, $jsSafe = false, $interpretBackSlashes = true)
	{
		...
		if ($string !== null)
		{
			...
			// Update JBD.JText script options
			Factory::getDocument()->addScriptOptions('JBD.jtexts', static::$strings, false);
		}
