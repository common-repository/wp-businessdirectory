...
<div class="jbd-container event-categories-slider-wrapper<?php echo $moduleclass_sfx; ?>" >
    <div class="slider-loader" id="slider-<?php echo $sliderId ?>-loader">
        <div class="loader"></div>
    </div>
    <div class="event-categories-slider responsive slider" id="slider-<?php echo $sliderId ?>">
