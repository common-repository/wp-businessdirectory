 ...
 */
class WP_BusinessDirectory_Categories_Events_Widget extends WP_Widget
{
	/**
	...
	{
		parent::__construct('wp_businessdirectory_categories_events_widget', // Base ID
			esc_html__('WP-BusinessDirectory Categories Events', 'text_domain'), // Name
			array(
				'description' => esc_html__('WP-BusinessDirectory Categories Events', 'text_domain')
			)) // Args
		;
	}
	...
	public function widget($args, $instance)
	{
		...
		wp_enqueue_style('wp_businessdirectory-categories-events-style', WP_BUSINESSDIRECTORY_URL.'includes/widgets/wp-businessdirectory-categories-events/assets/css/style.css');
		wp_enqueue_script('wp_businessdirectory-categories-events-script', WP_BUSINESSDIRECTORY_URL.'includes/widgets/wp-businessdirectory-categories-events/assets/js/script.js');
	...
	public function form($instance)
	{
		...
		try {
			...
			$form = \JForm::getInstance("categories-events", "bd-categories-events", array('control' => '', 'load_data' => false), true);
	...
	public function loadLanguage(){
	    ...
	    $x = $language->load( 'mod_jbusinesscategoriesevents' ,
	        dirname(dirname( __FILE__ )."/wp-businessdirectory-categories-events") ,
	        $language_tag,
	        true
	        );
	}
